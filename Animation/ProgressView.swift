...
class ProgressView: UIView {
    ...
    // Instantiate the progress shape layer to make the path
    ...
    func animateStroke(){
        ...
        let startAnimation = StrokeAnimation(type: .start, beginTime: 0.25 ,fromValue: 0, toValue: 1, duration: 0.75)
        
        let endAnimation = StrokeAnimation(type: .end, fromValue: 0, toValue: 1, duration: 0.75)
